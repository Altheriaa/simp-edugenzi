...
@section('title', 'Detail Penilaian — ' . $peserta->nama_lengkap)
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 p-5">
        <div class="flex items-center gap-4">
            ...
            <div class="flex-1 min-w-0">
                <h2 class="text-base font-bold text-gray-900 dark:text-white">{{ $peserta->nama_lengkap }}</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ $peserta->no_registrasi ?? '-' }}</p>
            </div>
            <div class="hidden sm:flex items-center gap-6 text-sm">
                <div class="text-center">
                    <p class="text-xs text-gray-400 mb-0.5">Program</p>
                    <p class="font-medium text-gray-700 dark:text-gray-300">{{ $peserta->programPelatihan->nama_program ?? '-' }}</p>
                </div>
                <div class="text-center">
                    <p class="text-xs text-gray-400 mb-0.5">Kelas</p>
                    <p class="font-medium text-gray-700 dark:text-gray-300 capitalize">{{ $peserta->jenisKelas->nama ?? '-' }}</p>
                </div>
                <div class="text-center">
                    <p class="text-xs text-gray-400 mb-0.5">Durasi</p>
                    <p class="font-medium text-gray-700 dark:text-gray-300">{{ $peserta->durasi_pelatihan ?? '-' }}</p>
                </div>
                <div class="text-center">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 overflow-hidden">
        ...
        @if ($penilaians->isEmpty())
            <div class="py-14 text-center text-gray-400">
                ...
                <p class="text-sm">Belum ada penilaian untuk peserta ini.</p>
                <a href="{{ route('mentor.penilaian.create', ['peserta_id' => $peserta->id]) }}"
