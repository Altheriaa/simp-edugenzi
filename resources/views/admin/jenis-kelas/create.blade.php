...
<div class="max-w-2xl space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Jenis Kelas</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Isi form berikut untuk menambah jenis kelas baru</p>
        </div>
    </div>

    {{-- Form --}}
    <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
        <form action="{{ route('admin.jenis-kelas.store') }}" method="POST">
            @csrf
            <div class="space-y-5">
                {{-- Nama Kelas --}}
                <div>
                    ...
                    <input type="text" id="nama" name="nama" value="{{ old('nama') }}"
                        ...
                        placeholder="Contoh: Reguler, Privat, Online" required />
                ...
                <div>
                    ...
                    <input type="text" id="slug" name="slug" value="{{ old('slug') }}"
                        ...
                        placeholder="Contoh: reguler, privat, online" />
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                        ...
                        <p class="text-gray-500 dark:text-gray-400">Kelas yang aktif akan muncul sebagai pilihan saat mendaftarkan peserta didik.</p>
                    </div>
                </div>
