...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Kelola detail program dan kombinasi durasi kelas</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
                ...
                <form action="{{ route('admin.program-pelatihan.update', $program) }}" method="POST">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="nama_program" name="nama_program" value="{{ old('nama_program', $program->nama_program) }}"
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                ...
                                <p class="text-gray-500 dark:text-gray-400">Program yang tidak aktif tidak akan muncul saat pendaftaran peserta didik.</p>
                            </div>
                        </div>
        ...
        <div class="lg:col-span-7">
            <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900 space-y-6">
                <div>
                    <h2 class="text-lg font-bold text-gray-900 dark:text-white">Kombinasi Kelas & Durasi</h2>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Tentukan jenis kelas dan durasi waktu pelatihan yang valid untuk program ini</p>
                </div>
                ...
                <div class="border border-gray-100 dark:border-gray-800 rounded-xl overflow-hidden">
                    <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-800">
                        <thead class="bg-gray-50 dark:bg-gray-800/50">
                            <tr>
                                <th class="px-4 py-2.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">Jenis Kelas</th>
                                <th class="px-4 py-2.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">Durasi Pelatihan</th>
                                <th class="px-4 py-2.5 text-right text-xs font-semibold text-gray-500 dark:text-gray-400">Aksi</th>
                            </tr>
                        </thead>
                            ...
                            @forelse ($combinations as $comb)
                                <tr>
                                    <td class="px-4 py-3 text-sm font-medium text-gray-900 dark:text-white">
                                        ...
                                        <span class="text-xs text-gray-400 font-normal">({{ $comb->jenisKelas->slug }})</span>
                                    </td>
                                    <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">
                                        {{ $comb->durasi_pelatihan }}
                                    </td>
                                    <td class="px-4 py-3 text-right">
                                        <form action="{{ route('admin.program-kelas-durasi.destroy', $comb->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus kombinasi ini?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-red-500 hover:text-red-700 text-xs font-semibold dark:hover:text-red-400">
                                                Hapus
                                            </button>
                                        </form>
                                    </td>
                ...
                <div class="p-4 bg-gray-50 dark:bg-gray-800/30 rounded-xl border border-gray-100 dark:border-gray-800">
                    ...
                    <form action="{{ route('admin.program-pelatihan.add-durasi', $program) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <label for="jenis_kelas_id" class="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">
                            ...
                            <div>
                                <label for="durasi_pelatihan" class="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">
                                    Durasi Pelatihan <span class="text-red-500">*</span>
                                </label>
