    ...
    <div class="space-y-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 p-5">
            <div class="flex items-center gap-4">
                <div
                    class="h-14 w-14 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center flex-shrink-0 shadow">
                    <span class="text-xl font-bold text-white">
                        {{ strtoupper(substr($enrollment->peserta->nama_lengkap, 0, 1)) }}
                    </span>
                </div>
                <div class="flex-1 min-w-0">
                    <h2 class="text-base font-bold text-gray-900 dark:text-white">{{ $enrollment->peserta->nama_lengkap }}
                    </h2>
                ...
                <div class="hidden sm:flex items-center gap-6 text-sm">
                    <div class="text-center">
                        ...
                        <p class="font-medium text-gray-700 dark:text-gray-300">
                            {{ $enrollment->programPelatihan->nama_program ?? '-' }}</p>
                    </div>
                    <div class="text-center">
                    ...
                    <div class="text-center">
                        ...
                        <p class="font-medium text-gray-700 dark:text-gray-300">{{ $enrollment->durasi_pelatihan ?? '-' }}
                        </p>
                    </div>
                    <div class="text-center">
                        <p class="text-xs text-gray-400 mb-0.5">Periode Dinilai</p>
                        <p class="font-bold text-blue-600 dark:text-blue-400">{{ $penilaians->count() }} / {{ $maxBulan }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 overflow-hidden">
            ...
            @else
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            @foreach ($penilaians as $penilaian)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        <span
                                            class="inline-flex items-center gap-0.5 text-sm font-bold text-blue-600 dark:text-blue-400">
                                            {{ $penilaian->rata_rata }}
                ...
                @if ($penilaians->count() > 1)
                    ...
                    @endphp
                    <div
                        class="px-6 py-3 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/20 flex items-center justify-end gap-2">
