        ...
        <form action="{{ route('admin.pengguna.update', $pengguna) }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap', $pengguna->nama_lengkap) }}"
                ...
                <div>
                    ...
                    <select id="role" name="role"
                        ...
                        <option value="peserta_didik" @selected(old('role', $pengguna->role) === 'peserta_didik')>Peserta Didik</option>
                    </select>
                </div>
