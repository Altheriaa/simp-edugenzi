                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    @forelse ($penggunas as $pengguna)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                            <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{{ $loop->iteration + ($penggunas->currentPage() - 1) * $penggunas->perPage() }}</td>
                            <td class="px-6 py-4">
                                <div>
                                    <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $pengguna->nama_lengkap }}</p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">@{{ $pengguna->username }}</p>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <x-modal-confirm :id="'delete-'.$pengguna->id" :action="route('admin.pengguna.destroy', $pengguna)">
                                        <button type="button"
