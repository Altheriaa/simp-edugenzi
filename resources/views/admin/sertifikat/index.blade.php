...
<div class="space-y-6">
    <div>
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Pantau seluruh sertifikat yang diterbitkan oleh mentor.</p>
    </div>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @foreach ($sertifikats as $sertifikat)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                                ...
                                <td class="px-6 py-3">
                                    <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $sertifikat->peserta->nama_lengkap }}</p>
                                </td>
                                <td class="px-6 py-3">
                                ...
                                <td class="px-6 py-3">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">{{ $sertifikat->mentor->nama_lengkap }}</span>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
