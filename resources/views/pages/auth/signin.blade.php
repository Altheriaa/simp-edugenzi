                ...
                <div class="mx-auto w-full max-w-md pt-10">
                    ...
                    <div>
                        ...
                        <div>
                            {{-- Error Validasi --}}
                            @if ($errors->any())
                                <div class="rounded-lg bg-red-50 border border-red-200 p-4 mb-4 dark:bg-red-900/20 dark:border-red-800">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email') }}"
                                            ...
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('email') border-red-400 @enderror" />
                                    </div>
                                    <!-- Password -->
                                    <div>
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            ...
                            <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                    Sistem Manajemen Proyek &mdash; <strong>Edugenzi Banda Aceh</strong>
                                </p>
                            </div>
                        </div>
                    </div>
